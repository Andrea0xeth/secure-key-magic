...
export const EventCardContent: FC<EventCardContentProps> = ({
  ...
  return (
    <div className="space-y-3 sm:space-y-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500 h-full">
      ...
      <div className="relative h-full pb-14">
        <p className="text-xs sm:text-sm text-white/90 line-clamp-3">
          {description}
        </p>
