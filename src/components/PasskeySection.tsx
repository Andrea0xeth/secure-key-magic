      ...
      <div className="space-y-6">
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <Shield className="h-12 w-12 text-artence-purple" />
          </div>
          ...
          <code className="px-4 py-3 bg-gray-100 dark:bg-gray-800 rounded-lg text-sm break-all block text-gray-800 dark:text-gray-200 transition-colors duration-300">
